            ...
            var ass = new Assertion
            {
                ...
                AttributeStatement = new[]
                {
                    new AttributeStatement
                    {
                        ...
                        Attribute = new[]
                        {
                            new Attribute {Name = "sosi:IDCardID", AttributeValue = Guid.NewGuid().ToString("D")},
                            new Attribute {Name = "sosi:IDCardVersion", AttributeValue = "1.0.1"},
                            new Attribute {Name = "sosi:IDCardType", AttributeValue = "user"},
                            new Attribute {Name = "sosi:AuthenticationLevel", AttributeValue = "4"}
                        }
                    },
                    new AttributeStatement
                    {
                        ...
                        Attribute = new[]
                        {
                            new Attribute {Name = "medcom:UserCivilRegistrationNumber", AttributeValue = "1802602810"},
                            new Attribute {Name = "medcom:UserGivenName", AttributeValue = "Stine"},
                            new Attribute {Name = "medcom:UserSurName", AttributeValue = "Svendsen"},
                            new Attribute {Name = "medcom:UserEmailAddress", AttributeValue = "stineSvendsen@example.com"},
                            new Attribute {Name = "medcom:UserRole", AttributeValue = "læge"},
                            new Attribute {Name = "medcom:UserAuthorizationCode", AttributeValue = "12345"}
                        }
                    },
                    new AttributeStatement
                    {
                        ...
                        Attribute = new[]
                        {
                            new Attribute {Name = "medcom:ITSystemName", AttributeValue = "Sygdom.dk"},
                            new Attribute {Name = "medcom:CareProviderID", AttributeValue = "30808460", NameFormat = "medcom:cvrnumber"},
                            new Attribute {Name = "medcom:CareProviderName", AttributeValue = "Statens Serum Institut"}
                        }
                    }
                }
            };
                ...
                AttributeStatement = new[]
                {
                    new AttributeStatement
                    {
                        ...
                        Attribute = new[]
                        {
                            ...
                            new Attribute {Name = "sosi:IDCardType", AttributeValue = "user"},
                            new Attribute {Name = "sosi:AuthenticationLevel", AttributeValue = "4"},
                            new Attribute {Name = "sosi:OCESCertHash", AttributeValue = Global.cert.GetCertHashString()}
                        }
                    },
                    new AttributeStatement
                    {
                        ...
                        Attribute = new[]
                        {
                            new Attribute {Name = "medcom:UserCivilRegistrationNumber", AttributeValue = "2408631478"},
                            new Attribute {Name = "medcom:UserGivenName", AttributeValue = "Amaja Christiansen"},
                            new Attribute {Name = "medcom:UserSurName", AttributeValue = "-"},
                            new Attribute {Name = "medcom:UserEmailAddress", AttributeValue = "jso@trifork.com"},
                            new Attribute {Name = "medcom:UserRole", AttributeValue = "5175"},
                            new Attribute {Name = "medcom:UserAuthorizationCode", AttributeValue = "5GXFR"}
                        }
                    },
                    new AttributeStatement
                    {
                        ...
                        {
                            new Attribute {Name = "medcom:ITSystemName", AttributeValue = "Sygdom.dk"},
                            new Attribute {Name = "medcom:CareProviderID", AttributeValue = "25520041", NameFormat = "medcom:cvrnumber"},
                            new Attribute {Name = "medcom:CareProviderName", AttributeValue = "TRIFORK SERVICES A/S // CVR:25520041"}
                        }
                    }
                }
            };
