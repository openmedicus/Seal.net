                ...
                AttributeStatement = new[]
                {
                    ...
                    new AttributeStatement
                    {
                        ...
                        Attribute = new[]
                        {
                            ...
                            new Attribute {Name = AttributeName.medcomUserEmailAddress, AttributeValue = UserInfo.Email},

                            new Attribute {Name = AttributeName.medcomUserRole, AttributeValue = UserInfo.Role},
                            new Attribute {Name = AttributeName.medcomUserAuthorizationCode, AttributeValue = UserInfo.AuthorizationCode},
                            new Attribute {Name = AttributeName.medcomUserOccupation, AttributeValue = UserInfo.Occupation}
                        }
                    },
                    new AttributeStatement
                    {
