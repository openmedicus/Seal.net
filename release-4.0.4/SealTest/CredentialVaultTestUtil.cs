...
namespace SealTest
{
	class CredentialVaultTestUtil
	{
		...
		{
			return GetCredentialVaultFromResource("oces2/PP/MOCES_cpr_gyldig.p12", "MocesGyldig");
		}

		public static GenericCredentialVault GetVocesCredentialVault()
		{
			var vault = GetCredentialVaultFromResource("oces2/PP/VOCES_gyldig.p12", "VocesGyldig");
			var systemCert = new X509Certificate2(TestContext.CurrentContext.TestDirectory +
														"/Resources/oces2/PP/system_vii.p12");
			//var systemCert = new X509Certificate2(TestContext.CurrentContext.TestDirectory +
			//											"/Resources/TDCOCESSTEST2.cer");
			vault.AddTrustedCertificate(systemCert);
			return vault;
		}

		public static GenericCredentialVault GetOldIdpTestCredentialVault()
		{
			return GetCredentialVaultFromBase64String(OldNemloginIdpCertificateString, "OldIdp");
		}

		public static GenericCredentialVault GetNewIdpTestCredentialVault()
		{
			return GetCredentialVaultFromBase64String(NewNemloginIdpCertificateString, "NewIdp");
		}

		public static GenericCredentialVault GetCredentialVaultFromResource(string resourceName, string postFix, string password = "Test1234")
		{
			var credentialVault = new GenericCredentialVault("TestStore" + postFix);
		...
		{
			return GetCredentialVaultFromResource("voces2.pkcs12", "OCES2", "1234Test");
		}
